...
\### Example 1: Basic Usage with a Simple Sequence The example below demonstrates how to use \`character_counts1()\` on a simple string with repeated characters:
